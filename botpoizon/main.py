...
faq_words = {
    ...
    'faq3': '❗️ Мы гарантируем самую быструю и бережную доставку товара в Россию, которая занимает всего +- 20 дней с момента заказа до нашего склада в Москве. Доставка осуществляется автотранспортом и занимает до 15 дней. Иногда возможны задержки на таможне, однако это происходит крайне редко. Мы обязательно свяжемся с вами и предупредим о любых задержках.',
